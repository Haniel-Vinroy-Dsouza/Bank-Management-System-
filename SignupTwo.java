...
public class SignupTwo extends JFrame implements ActionListener{
    ...
    SignupTwo(String formno){
        ...
        String valReligion [] = {"Christian", "Hindu", "Muslim", "Sikh", "Other"};
        ...
        String valIncome [] = {"None", "< 1,50,00", "< 2,50,000", "< 5,00,000", "upto 10,00,000"};
        ...
        email.setBounds(100, 320, 200, 40);
        add(email);
        ...
        String occupationalValues [] = {"Salaried Employ", "Self Employed", "Buissness Man", "Student", "Other"};
        ...
        existingButtonGroup.add(eyes);
        existingButtonGroup.add(eno);
